...
setwd("C:/Users/ido/sheba stats/ACSIS/Booklet/R script")
```
...
tab_radial_ppci_trend <- print(CreateTableOne(vars = "PCIVA", strata = "year", data = subset(dat_10_24, admecg=="ST elevation" & REP=="YES")))[,1:5]
