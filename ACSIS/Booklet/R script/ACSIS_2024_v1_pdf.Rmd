...
xx_arr_rep <- barplot(t(as.matrix(mydata_arr_rep)), main="Figure 1.19: Length of Time from Arrival to Reperfusion \n(Median, 25%-75%)",  col=c("cadetblue2", "mediumpurple","cadetblue2"), las=1, horiz = T, xlim = c(0,100), names.arg = c("Arrival-Rep", #"Arrival-TLx",
...
xx_arr_rep_w <- barplot(t(as.matrix(mydata_arr_rep_w)), main="Women",  col=c("cadetblue2","mediumpurple","cadetblue2"), las=1, horiz = T, xlim = c(0,140), names.arg = c("Arrival-Rep", #"Arrival-TLx",
...
xx_arr_rep_m <- barplot(t(as.matrix(mydata_arr_rep_m)), main="Men",  col=c("cadetblue2","mediumpurple","cadetblue2"), las=1, horiz = T, xlim = c(0,140), names.arg = c("Arrival-Rep",#"Arrival-TLx",
  "Arrival-PPCI"), xlab = "Time (minutes)")
...
```{r results='hide'}
vars_out <- c("S24DISDIE","DIED7","DIED30","MACE_OLD", "DIED365") 
...
Ninety-day follow-up was performed for `r nrow(dat_fu)` (`r round((nrow(dat_fu) / nrow(dat))*100)`%) patients. Of which `r table(dat_fu$S24FU_CONTACT)["Telephone"]` (`r  round(100*prop.table(table(dat_fu$S24FU_CONTACT))["Telephone"])`%) were contacted by phone, `r table(dat_fu$S24FU_CONTACT)["Clinic visit"]` (`r  round(100*prop.table(table(dat_fu$S24FU_CONTACT))["Clinic visit"])`%) by clinical visits and `r table(dat_fu$S24FU_CONTACT)["Virtual communication"]` (`r  round(100*prop.table(table(dat_fu$S24FU_CONTACT))["Virtual communication"])`%) by virtual communication. Most of the patients were asymptomatic and in NYHA Class I.
