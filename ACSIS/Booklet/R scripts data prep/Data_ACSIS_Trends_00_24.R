...
dat0 <- read.csv("C:/Users/talco/Documents/Statistics/ACSIS_21_PDF/R00_21_4.csv", 
                 header = TRUE, na.strings = c(""," ","NA","UNKNOWN","UNK","N/A","A","N"), 
                 stringsAsFactors = T) #n=18739

dat <- droplevels(subset(dat0, 
                           SOURCE %in% c("S2010","S2013","S2016","S2018", "S2021"))) #n=8983
...
dat_10 <- read.csv("C:/Users/talco/Documents/Statistics/ACSIS_21_PDF/previous years acsis files/REG10_8.csv", 
                 header = TRUE, na.strings = c(""," ","NA","UNKNOWN","UNK","N/A","A","N"), 
                 stringsAsFactors = T) 
...
dat_13 <- read.csv("C:/Users/talco/Documents/Statistics/ACSIS_21_PDF/previous years acsis files/REG13_4_save_utf.csv", 
                   header = TRUE, na.strings = c(""," ","NA","UNKNOWN","UNK","N/A","A","N"), 
                   stringsAsFactors = T) 
...
dat_16 <- read.csv("C:/Users/talco/Documents/Statistics/ACSIS_21_PDF/previous years acsis files/REG16_5_save_utf.csv", 
                   header = TRUE, na.strings = c(""," ","NA","UNKNOWN","UNK","N/A","A","N"), 
                   stringsAsFactors = T) 
...
dat_18 <- read.csv("C:/Users/talco/Documents/Statistics/ACSIS_21_PDF/previous years acsis files/ACSIS18_5_save_utf.csv", 
                   header = TRUE, na.strings = c(""," ","NA","UNKNOWN","UNK","N/A","A","N"), 
                   stringsAsFactors = T) 
...
dat_21 <- read.csv("C:/Users/talco/Documents/Statistics/ACSIS_21_PDF/ACSIS24_3_save_utf_updated.csv", header = TRUE, 
...
dat$oral_anticoag_hosp <- factor(ifelse(dat$HLMW%in%"YES" |
            ...
            (dat$SOURCE=="S2013" & is.na(dat$S13H5)  & is.na(dat$S13H10) & is.na(dat$S13H11)) |
              ...
              (dat$SOURCE=="S2021" & is.na(dat$S24H6)  & is.na(dat$S24H7) & is.na(dat$S24H8) & is.na(dat$S24H9)) ,
            NA, "NO")))
...
dat$oral_anticoag_disch <- factor(ifelse(dat$DLMW%in%"YES" |
                                        ...
                                        ifelse((dat$SOURCE=="S2010" & is.na(dat$S10D2)) |
                                                 ...
                                                 (dat$SOURCE=="S2021" & is.na(dat$S24D6)  & is.na(dat$S24D7) & is.na(dat$S24D8) & is.na(dat$S24D9)) ,
                                               NA, "NO")))
#many missing in 2018 - turn to "no":
